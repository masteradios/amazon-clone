...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      ...
      logo: AssetImage('assets/construction.png'),
      title: 'Roadworks',
      theme: LoginTheme(
        bodyStyle: TextStyle(color: Colors.brown, fontWeight: FontWeight.w800),
        titleStyle: TextStyle(color: Colors.white, fontSize: 35),
